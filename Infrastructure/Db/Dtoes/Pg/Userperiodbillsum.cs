...
{
    [Table("userperiodbillsum")]
    public partial class Userperiodbillsum
    {
        ...
        [Column("downloadbillcount")]
        public double? Downloadbillcount { get; set; }
        ...
        [Column("ishavearrears")]
        [StringLength(255)]
        public string Ishavearrears { get; set; }
        [Column("ishavedetail")]
        [StringLength(255)]
