...
namespace Infrastructure.Db.Dtoes.Mongo.Customer
{
    [Table("UserInfo")]
    public class UserInfo
    {
        ...
        /// 客户信誉级别1:初级
        /// </summary>
        public UsersInfoCreditRating CreditRating { set; get; }

        /// <summary> 
        /// 客户类别序号
        /// </summary>
        public CustomType CtId { set; get; }
        ...
        /// 证件类型编号
        /// </summary>
        public IdentityCard? IdctId { set; get; }
        ...
        /// </summary>
        public UsersInfoState StateFlag { set; get; }
        ...
        /// </summary>
        public UserAccountType UType { set; get; }
        ...
        /// 平台类型
        /// </summary>
        public List<SalesPlatformFlag> PlatformFlags { get; set; }
        ...
        /// 审核状态
        /// </summary>
        public UserAuditState AuditState { get; set; }
