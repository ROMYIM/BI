...
namespace Infrastructure.Db.Dtoes.Pg
{
    ...
    public partial class Usermoneyreturnrecord
    {
        [Column("ccode")]
        [StringLength(255)]
        public string Ccode { get; set; }
        [Column("platformumoney")]
        ...
        [Column("returntype")]
        public double? Returntype { get; set; }
        [Column("weight")]
        [StringLength(255)]
        ...
        [Column("retrundatetime")]
        [StringLength(255)]
        public string Retrundatetime { get; set; }
